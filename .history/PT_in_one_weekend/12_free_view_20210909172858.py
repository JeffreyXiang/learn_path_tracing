...
class Camera:
    ...
    def set_direction(self, yaw, pitch, roll=0):
        ...
        self.update_local_coord()

    def look_at(self, target, roll=0):
        position = self.info[None].position
    ...
    def move_front(self, d):
        self.position += Vec3f(d) * self.front_axis

    def move_right(self, d):
        self.position += Vec3f(d) * self.right_axis
