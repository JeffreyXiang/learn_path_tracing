...
class Camera:
    def __init__(self, resolution, fov=60, focal_length=1, aperture=0):
        self.resolution = Vec2i.field(())
        self.fov = ti.field(ti.f32, ())
        self.focal_length = ti.field(ti.f32, ())
        self.aperture = ti.field(ti.f32, ())
        self.position = Vec3f.field(())
        self.yaw = ti.field(ti.f32, ())
        self.pitch = ti.field(ti.f32, ())
        self.roll = ti.field(ti.f32, ())
