...
class Camera:
    def __init__(self, resolution, fov=60, focal_length=1, aperture=0):
        ...
        self.position = Vec3f(0.0)
        self.front_axis = Vec3f(0.0)
        self.right_axis = Vec3f(0.0)
        self.up_axis = Vec3f(0.0)
        self.yaw = 0.0
        self.pitch = 0.0
        self.roll = 0.0
    ...
    def update_attitude(self):
        ...
        self.front_axis = Vec3f(trans @ Vec3f([0.0, 0.0, -1.0]))
        self.right_axis = Vec3f(trans @ Vec3f([1.0, 0.0, 0.0]))
        self.up_axis = Vec3f(trans @ Vec3f([0.0, 1.0, 0.0]))
        self.position = self.position
        self.info[None].front_axis = self.front_axis
        self.info[None].right_axis = self.right_axis
        self.info[None].up_axis = self.up_axis
